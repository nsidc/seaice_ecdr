...
# TODO: The multiprocess daily invocation causes an error if the temporal_composite_daily
#       interpolation attempts to access a day prior to the start of SMMR (10/25/1978)
