...
def get_dataset_for_gridid(gridid, grid_date, return_dataset=True):
    ...
    """
    if return_dataset:
        logger.info(f'Creating georeferenced dataset on {gridid} grid for {grid_date}')  # noqa
    crs_attrs = {}

    # CRS for polar stereo grids
    if gridid[:2] == 'ps':
        crs_attrs['grid_mapping_name'] = 'polar_stereographic'
        crs_attrs['false_easting'] = 0.
        crs_attrs['false_northing'] = 0.
        crs_attrs['semi_major_axis'] = 6378273.
        ...
        if 'psn' in gridid:
            ...
            crs_attrs['straight_vertical_longitude_from_pol'] = -45.
            crs_attrs['latitude_of_projection_origin'] = 90.
            crs_attrs['standard_parallel'] = 70.
            crs_attrs['proj4text'] = "+proj=stere +lat_0=90 +lat_ts=70 +lon_0=-45 +k=1 +x_0=0 +y_0=0 +a=6378273 +b=6356889.449 +units=m +no_defs"
            crs_attrs['srid'] = "urn:ogc:def:crs:EPSG::3411"
            crs_attrs['crs_wkt'] = 'PROJCS["NSIDC Sea Ice Polar Stereographic North",GEOGCS["Unspecified datum based upon the Hughes 1980 ellipsoid",DATUM["Not_specified_based_on_Hughes_1980_ellipsoid"’,SPHEROID["Hughes 1980",6378273,298.279411123061,AUTHORITY["EPSG","7058"]],AUTHORITY["EPSG","6054"]],PRIMEM["Greenwich",0,AUTHORITY["EPSG","8901"]],UNIT["degree",0.0174532925199433,AUTHORITY["EPSG","9122"]],AUTHORITY["EPSG","4054"]],PROJECTION["Polar_Stereographic"],PARAMETER["latitude_of_origin",70],PARAMETER["central_meridian",-45],PARAMETER["scale_factor",1],PARAMETER["false_easting",0],PARAMETER["false_northing",0],UNIT["metre",1,AUTHORITY["EPSG","9001"]],AXIS["X",EAST],AXIS["Y",NORTH],AUTHORITY["EPSG","3411"]]'
        ...
        crs_attrs['longitude_of_projection'] = 0.
        crs_attrs['false_easting'] = 0.
        crs_attrs['false_northing'] = 0.
        crs_attrs['semi_major_axis'] = 6378137.
        crs_attrs['inverse_flattening'] = 298.257223563
        ...
        if gridid[:3] == 'e2n':
            ...
            crs_attrs['latitude_of_projection_origin'] = 90.
            crs_attrs['proj4text'] = '+proj=laea +lat_0=90 +lon_0=0 +x_0=0 +y_0=0 +ellps=WGS84 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs'
    ...
    crs_attrs['long_name'] = \
            crs_attrs['long_name'].format(res_km=res_km)
    if gridid[:3] == 'e2t':
