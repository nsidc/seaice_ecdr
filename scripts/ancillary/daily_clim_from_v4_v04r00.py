...
Note: this version uses the CDRv4 (v04r00) ancillary information
      and is used to directly compare v5 code output with (published) v4 files
"""
...
# The commented out lines are old method...
...
CDR_V4_ANCILLARY_DIR = Path(
    "/share/apps/G02202_V5/cdrv4_ancillary/vagrant_source_ancillary/ancillary"
)
...
def get_v4_icemask_exact(
    *,
    surftype: npt.NDArray,
    old_vim: npt.NDArray,
...
def make_v5_climatology(*, hemisphere: Hemisphere):
    ...
    icemask_arr = get_v4_icemask_exact(
        surftype=ancillary_ds.surface_type.data,
        old_vim=v4_ds.daily_icemask.data,
    )
